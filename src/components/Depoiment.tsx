            ...
            <div className="container">
                <div className="flex flex-col items-start space-y-8">
                    ...
                    <div className="grid  grid-cols-3 gap-4 max-xl:grid-cols-3 max-lg:grid-cols-2 max-sm:grid-cols-1 w-full justify-center">
                        ...
                        <div className="shadow-md p-8 rounded-xl space-y-4">
                            <h1 className="italic text-5xl bg-text-gradient bg-clip-text text-transparent h-max">""</h1>
                            <p className="w-64 text-white">Money is only a tool. It will take you wherever you wish, but it
                                will not replace you as the driver.</p>
                            <div className="flex items-center gap-2">
                                <img width={48} src={People2} alt="" />
                                <div className="flex flex-col">
                                    <span className="text-white">Herman Jensen</span>
                                    <span className="text-white/50">Founder & Leader</span>
                                </div>
                        ...
                        <div className="shadow-md p-8 rounded-xl space-y-4">
                            <h1 className="italic text-5xl bg-text-gradient bg-clip-text text-transparent h-max">""</h1>
                            <p className="w-64 text-white">It is usually people in the money business, finance, and international trade that are really rich.</p>
                            <div className="flex items-center gap-2">
                                <img width={48} src={People3} alt="" />
                                <div className="flex flex-col">
